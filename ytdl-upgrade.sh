...
[[ $(id -u) -ne 0 ]] && echo "Please run as root!" && exit 255
[[ -z "$(command -v youtube-dl)" ]] && echo "youtube-dl not found!" && exit 1 # https://stackoverflow.com/questions/18215973/how-to-check-if-running-as-root-in-a-bash-script
